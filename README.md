...
1. **趋势持续性更强**。A 股散户占比高、信息效率低，趋势一旦形成往往持续数月至一年——不像美股那样几天内被套利资金抹平。实测 2015-2026 年间 CSI300 站上 120MA 且持续 5 天以上的事件共 32 次，其中位数持续 12 个交易日（约 0.6 个月），但均值被少数长趋势拉至 45 个交易日（约 2 个月），最长一次连续 186 个交易日（约 9 个月）。真正的持续上升趋势每年总能出现几次，给了动量策略足够的持仓窗口。
...
|---------|------|---------|---------|--------|
| **价值投资**（买好公司长期持有） | "我相信这家公司未来会更好" | 满仓暴露，无法规避系统性下跌 | 深度回撤（2022-2025 沪深 300 累跌近 5%） | 需要对个股有深度认知，普通投资者信息劣势明显 |
...
| **本策略** | "当市场确认趋势时参与，否则在债券里等待" | 4 年测试期 48 个月中 13 个月满仓、6 个月半仓、29 个月防御性持有债券（等效满仓暴露约 16 个月，占 33%） | **Test 期 MaxDD 6.7%**——对比 CSI300 的 36.1%，且正收益（+3.78% CAGR），说明回撤控制并非是牺牲收益换来的 | 自动识别牛熊，无需主观判断。防御时本金在债券中不动，进攻时追动量 |
...
3. **趋势下跌时**（如 2022 年）：策略在 11 个月里处于防御或冷却状态，仅在 7 月短暂全仓投入动量股（5 只股票月均 +9.8%）。全年以 +8.93% 收尾，同期 CSI300 跌 -21.9%。

**资金利用率不是越高越好**。本策略在测试期 48 个月中有 29 个月防御性持有债券（加上冷却期共占 60% 时间），但剩余 19 个月的进攻窗口足以产生 +3.78% 的年化回报。空仓等待不是"闲置"——是在等 CSI300 确认站上 120MA，是在等下一个 Sharp3pct 冷却期结束，是在等市场给出信号而非投资者自己猜方向。
